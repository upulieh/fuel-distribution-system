package com.cpc.scheduleservice.config;
...
class KafkaSDProducerConfig {
	...
	@Bean
	public Map<String, Object> sdProducerConfigs() {
	...
	@Bean
	public ProducerFactory<String, SDDTO> sdProducerFactory() {
		return new DefaultKafkaProducerFactory<>(sdProducerConfigs());
	}

//	KafkaTemplate helps us to send messages to their respective topic
	@Bean
	public KafkaTemplate<String, SDDTO> scheduleDispatchKafkaTemplate() {
		return new KafkaTemplate<>(sdProducerFactory());
	}
}